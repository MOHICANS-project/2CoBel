...
\index{Evidence@{Evidence}!dfs\+Disj@{dfs\+Disj}}
\index{dfs\+Disj@{dfs\+Disj}!Evidence@{Evidence}}
\subsubsection[{\texorpdfstring{dfs\+Disj(std\+::unordered\+\_\+map$<$ size\+\_\+t, std\+::vector$<$ size\+\_\+t $>$$>$ \&adj\+\_\+list, size\+\_\+t current\+\_\+pos, T path, std\+::unique\+\_\+ptr$<$ Focal\+Element $>$ current\+\_\+intersection, std\+::vector$<$ std\+::unique\+\_\+ptr$<$ Focal\+Element $>$$>$ \&output\+\_\+vec, std\+::vector$<$ std\+::unordered\+\_\+set$<$ size\+\_\+t $>$$>$ \&check, std\+::vector$<$ size\+\_\+t $>$ \&indices, std\+::vector$<$ int $>$ \&parents, size\+\_\+t cur\+\_\+root) const }{dfsDisj(std::unordered_map< size_t, std::vector< size_t >> &adj_list, size_t current_pos, T path, std::unique_ptr< FocalElement > current_intersection, std::vector< std::unique_ptr< FocalElement >> &output_vec, std::vector< std::unordered_set< size_t >> &check, std::vector< size_t > &indices, std::vector< int > &parents, size_t cur_root) const }}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ void Evidence\+::dfs\+Disj (
\begin{DoxyParamCaption}
\item[{std\+::unordered\+\_\+map$<$ size\+\_\+t, std\+::vector$<$ size\+\_\+t $>$$>$ \&}]{adj\+\_\+list, }
\item[{size\+\_\+t}]{current\+\_\+pos, }
\item[{T}]{path, }
\item[{std\+::unique\+\_\+ptr$<$ {\bf Focal\+Element} $>$}]{current\+\_\+intersection, }
\item[{std\+::vector$<$ std\+::unique\+\_\+ptr$<$ {\bf Focal\+Element} $>$$>$ \&}]{output\+\_\+vec, }
\item[{std\+::vector$<$ std\+::unordered\+\_\+set$<$ size\+\_\+t $>$$>$ \&}]{check, }
\item[{std\+::vector$<$ size\+\_\+t $>$ \&}]{indices, }
\item[{std\+::vector$<$ {\bf int} $>$ \&}]{parents, }
\item[{size\+\_\+t}]{cur\+\_\+root}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}}\hypertarget{classEvidence_af782e3c907c074e903fcda7456265454}{}\label{classEvidence_af782e3c907c074e903fcda7456265454}
