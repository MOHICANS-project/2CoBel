    ...
    void perform_rendering(Scanline &sl, Ras &ras, Ren &ren, Clp &clp) {
        if (m_operation.cur_item() > 0) {
            ...
            switch (m_operation.cur_item()) {
                case 1:
                    clp.operation(agg::clipper_or);
                    break;
                case 2:
                    clp.operation(agg::clipper_and);
                    break;
                case 3:
                    clp.operation(agg::clipper_xor);
                    break;
                case 4:
                    clp.operation(agg::clipper_a_minus_b);
                    break;
                case 5:
                    clp.operation(agg::clipper_b_minus_a);
                    break;
            }
    ...
    unsigned render_clipper(Scanline &sl, Ras &ras) {
        ...
        switch (m_polygons.cur_item()) {
            case 0: {
                ...
                agg::conv_clipper<agg::path_storage, agg::path_storage> clp(ps1, ps2, agg::clipper_or,
            ...
            case 1: {
                ...
                agg::conv_clipper<agg::path_storage,
                        agg::conv_stroke<agg::path_storage> > clp(ps1, stroke, agg::clipper_or, agg::clipper_non_zero,
                                                                  agg::clipper_non_zero);
            ...
            case 2: {
                ...
                agg::conv_clipper<agg::conv_transform<agg::path_storage>,
                        agg::conv_transform<agg::path_storage> > clp(trans_gb_poly, trans_arrows, agg::clipper_or,
            ...
            case 3: {
                ...
                agg::conv_clipper<agg::conv_transform<agg::path_storage>,
                        agg::conv_stroke<spiral> > clp(trans_gb_poly, stroke, agg::clipper_or, agg::clipper_non_zero,
                                                       agg::clipper_non_zero);
            ...
            case 4: {
                ...
                agg::conv_clipper<agg::conv_stroke<spiral>,
                        agg::conv_curve<
                                agg::conv_transform<
                                        agg::path_storage> > > clp(stroke, curve, agg::clipper_or,
                                                                   agg::clipper_non_zero, agg::clipper_non_zero);
